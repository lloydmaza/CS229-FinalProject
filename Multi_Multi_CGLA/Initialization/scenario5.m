function [uavs, threats, targets, n] = scenario5()
...
targets{4}.state.x = 10; 
targets{4}.state.y = 11;
...
threats{7}.state.x = 11.5; 
threats{7}.state.y = 13;
threats{7}.state.found = false;
threats{7}.trait.cov = 1.1.*eye(2);

threats{8}.state.x = 7.25; 
threats{8}.state.y = 12;
threats{8}.state.found = false;
threats{8}.trait.cov = 1.75.*eye(2);

threats{9}.state.x = 10; 
threats{9}.state.y = 13;
threats{9}.state.found = false;
threats{9}.trait.cov = [4 0; 0 1];
