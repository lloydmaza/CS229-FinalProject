...
targets{2}.state.x = 2; targets{2}.state.y = 2; targets{2}.state.visited = 1;
targets{3}.state.x = 3; targets{3}.state.y = 1; targets{3}.state.visited = 0;
targets{4}.state.x = 9; targets{4}.state.y = 2; targets{4}.state.visited = 1;
targets{5}.state.x = 2; targets{5}.state.y = 9; targets{5}.state.visited = 1;
...
uavs{1}.state.x = 9; uavs{1}.state.y = 9; uavs{1}.trait.or = 10; uavs{1}.state.active = 1;
uavs{1}.trait.target = 5;
uavs{2}.state.x = 3; uavs{2}.state.y = 3; uavs{2}.trait.or = 10; uavs{2}.state.active = 0;
uavs{2}.trait.target = 7;
